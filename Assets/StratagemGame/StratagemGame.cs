...
public class StratagemGame : MonoBehaviour {
    ...
    /// <summary>
    /// Comienza juego de flechas estilo estratagemas de Helldivers con el codigo deseado. El codigo est� compuesto de las flechas arriba, izquierda, abajo, derecha, representadas por caracteres "wasd"
    /// </summary>
